...
survey.weight.sub <- subset(survey.i, subset = weight.2011 > 90)
survey.weight.sub2004 <- subset(survey.i, subset = weight.2004 > 90)
...
weight.colors <- c("tomato2", "#999999")
weight.plot <- ggplot(data=survey.weight.sub, aes(x=weight.2011, y=income.lastyr, color=gender))
weight.plot + geom_point(size = 1.5, alpha = 0.75) +
